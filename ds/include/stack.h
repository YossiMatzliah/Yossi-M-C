#ifndef __ILRD__OL139_40_STACK__
#define __ILRD__OL139_40_STACK__

/*
#This is an implementation of Stack using an array
#TOP is inintialized to -1 and get updated with every operation
