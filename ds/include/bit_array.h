...
*
* @param:
*	bit_arr - the bit array to mirror the bits in. 
*
* @Return
*	returns the updated bit array
*
...
/* 
* Description
*	Rotates left 'step' times the bit array 
*
* @param:
*	bit_arr - the bit array to set the bit in.
*	step - the number of rotations to do, should be 0-63
*	sending an index outside this range could cause undefiend behaviour.	 
*
* @Return
*	returns the updated bit array
...
/* 
* Description
*	Rotates right 'step' times the bit array 
*
* @param:
*	bit_arr - the bit array to set the bit in.	 
*	step - the number of rotations to do, should be 0-63
