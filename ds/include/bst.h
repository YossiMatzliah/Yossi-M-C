...
/* The BST traversed in IN_ORDER, means from lowest value to the highest */
...
*		Note: Sending EndIter would cause an undefined behavior.
* 		If the iterator is invalid - the behavior is undefined.
* 
* @return:
...
* @param:
*	iter - iterator to a key in the bst.
*		Note: Sending BeginIter would cause an undefined behavior.
* 		If the iterator is invalid - the behavior is undefined.
* 
* @return:
